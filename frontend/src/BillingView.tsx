...
const comparisonRows: CompareRow[] = [
  ...
  { type: 'row', feature: 'Análisis por mes', free: text('Ilimitados (1 sitio)'), pro: text('Ilimitados'), enterprise: text('Ilimitados') },
  { type: 'row', feature: 'Sitios auditables', free: text('1 URL'), pro: text('Sin límite'), enterprise: text('Sin límite') },
  ...
  { type: 'row', feature: 'Historial de análisis', free: text('Solo su sitio'), pro: mark(true), enterprise: mark(true) },
  ...
  { type: 'row', feature: 'Reporte técnico con respaldo normativo', free: mark(false), pro: mark(true), enterprise: mark(true) },
  ...
  { type: 'row', feature: 'Proyectos activos', free: mark(false), pro: text('Sin límite'), enterprise: text('Sin límite') },
