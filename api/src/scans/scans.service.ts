...
export class ScansService {
  ...
  private extensionApplicabilityReason(id: string, applies: boolean): string {
    if (applies) {
      return 'Aplica según el contenido detectado en la pestana autenticada.';
    }
    const reasons: Record<string, string> = {
      '1.1.1': 'No se detectaron imagenes, SVG funcional, audio, video, canvas ni contenido no textual relevante.',
      '1.2.1': 'No se detectó audio o video.',
      '1.2.2': 'No se detectó audio o video.',
      '1.2.3': 'No se detectó video.',
      '1.2.4': 'No se detectó audio o video en vivo.',
      '1.2.5': 'No se detectó video.',
      '1.2.6': 'No se detectó audio o video.',
      '1.2.7': 'No se detectó video.',
      '1.2.8': 'No se detectó audio o video.',
      '1.2.9': 'No se detectó audio en vivo.',
      '1.3.5': 'No se detectaron controles de entrada.',
      '1.4.2': 'No se detectó audio o video con reproducción automática.',
      '1.4.5': 'No se detectaron imagenes de texto.',
      '1.4.7': 'No se detectó audio o video.',
      '1.4.9': 'No se detectaron imagenes de texto.',
      '1.4.11': 'No se detectaron controles, iconos funcionales o gráficos relevantes.',
      '1.4.13': 'No se detectó contenido activado por hover o foco.',
      '2.1.4': 'No se detectaron atajos de teclado personalizados.',
      '2.2.1': 'No se detectaron limites de tiempo.',
      '2.2.2': 'No se detectó contenido en movimiento automático.',
      '2.2.3': 'No se detectaron limites de tiempo.',
      '2.2.4': 'No se detectaron interrupciones o mensajes dinámicos.',
      '2.2.5': 'No se detectó reautenticación.',
      ...
      '2.3.3': 'No se detectaron animaciones activadas por interacción.',
      '2.4.4': 'No se detectaron enlaces.',
      '2.4.5': 'No se detectó estructura multipagina.',
      '2.4.6': 'No se detectaron encabezados ni formularios.',
      '2.4.8': 'No se detectó estructura multipagina.',
      '2.4.9': 'No se detectaron enlaces.',
      '2.4.10': 'No se detectaron encabezados.',
      '2.5.1': 'No se detectaron gestos o trayectorias.',
      '2.5.4': 'No se detectó funcionalidad por movimiento del dispositivo.',
      '2.5.7': 'No se detectó drag and drop.',
      ...
      '3.1.6': 'No se detectó contenido que requiera pronunciacion especial.',
      '3.2.3': 'No se detectó estructura multipagina.',
      '3.2.4': 'No se detectó estructura multipagina.',
      '3.2.6': 'No se detectó mecanismo de ayuda.',
      ...
      '3.3.7': 'No se detectó proceso multipaso.',
      '3.3.8': 'No se detectó autenticación ni captcha.',
      '3.3.9': 'No se detectó autenticación ni captcha.',
      '4.1.3': 'No se detectaron mensajes de estado dinámicos.',
    };
    return reasons[id] || 'No se detectó condicion de aplicabilidad para este criterio.';
  }
